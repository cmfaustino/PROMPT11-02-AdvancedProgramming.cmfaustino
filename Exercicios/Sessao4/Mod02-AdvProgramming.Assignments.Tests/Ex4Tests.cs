namespace Mod02_AdvProgramming.Assignments.Tests
{
    ...
    public class Ex4Tests {
        [Test]
        public void CountRepeatedShouldReturnAPairSequenceWhenThereAreRepeatedElementsAndRepeatedAtEnd() {
            // Arrange
            int[] v = { 0, 1, 1, 2, 3, 3, 3, 4, 5, 5 };

            // Act
            IEnumerable<Ex4.Pair<int, int>> repeated = Ex4.CountRepeated(v);

            // Assert
            Assert.AreEqual(3, repeated.Count());
        }

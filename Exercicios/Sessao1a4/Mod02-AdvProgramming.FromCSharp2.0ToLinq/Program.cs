...
namespace Mod02_AdvProgramming_FromCSharp2_0ToLinq 
{
    ...
    public class Program 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // 1 Automatic Properties in Customers
            ...
            //foreach (Customer c in SampleData.LoadCustomersFromMemoryNew())
            //{
            ...
            // Now with Linq
            //var query = from c in SampleData.LoadCustomersFromMemoryNew()
            ...
            var query = SampleData.LoadCustomersFromMemoryNew().Where(c => c.City.StartsWith("M")).
                        GroupBy(c => c.City).
